...
public class TestResource {
	private static School getSampleSchool(String name) {
		Subject subjectE = new Subject(0L, "Englisch", "E", 2);
		Subject subjectAM = new Subject(1L, "Angewandte Mathematik", "AM", 3);

		HashSet<SchoolClass> schoolClasses = getSchoolClasses(subjectE, subjectAM);
	...
	private static @NotNull HashSet<SchoolClass> getSchoolClasses(Subject subjectE, Subject subjectAM) {
...
//	}
	...
	public static class MultipleStringsReturnObject {
