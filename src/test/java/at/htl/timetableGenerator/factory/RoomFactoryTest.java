...
class RoomFactoryTest {
	...
	void testCreateFromFile() {
		RoomFactory roomFactory = new RoomFactory(); //Needed, so jacoco recognizes the default constructor as tested
		...
		assertThrows(ImportException.class, () -> {
			RoomFactory.createFromFile("non/existing/path/but/pls/never_add/folders/called/like/this/or/everything/will/brake.csv", ";");
		});
	}
}